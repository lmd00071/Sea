...
//
//@interface DownManager()<NSXMLParserDelegate>
//
////记录当前解析的是哪个标签
...
////            
////            manager=[[DownManager alloc]init];
////        });
////    }
////    return manager;
////}
//
//
//- (void)searchFromNetDelegateAction:(id<DownManagerDelegate>)delegate DnsUrl:(NSString *)dnsUrl action_parameter:(NSString *)action_parameter cellNumber:(NSInteger)cellNumber
//{
...
//    
////       NSString *bodyStr=[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"UTF-8\"?><infobus><trans_code>ui_show</trans_code><from_system>海燕微客互动平台</from_system><from_client_id>54:59:C2:2A:0A:B2</from_client_id><yc_user_role>parent</yc_user_role><cmd /><action>hyan_tmat_download_book</action><action_parameter>textbook_uid=%@</action_parameter></infobus>",action_parameter];
//    
//    //1.基础的url
...
//        
//    }
//    if ([self.currentElementName isEqualToString:@"template_data_csv1"]&&self.csvModel.template_data_csv1==nil) {
//        
//        self.csvModel.template_data_csv1=string;
//        
//    }
//    if ([self.currentElementName isEqualToString:@"template_data_csv2"]&&self.csvModel.template_data_csv2==nil) {
//        
//        self.csvModel.template_data_csv2=string;
//        
//    }
//    
//}
...
//    dispatch_async(dispatch_get_main_queue(), ^{
//        
//        if (self.delegate && [self.delegate respondsToSelector:@selector(passCsvDataMore:uid:cellNumber:)]) {
//            
//            [self.delegate passCsvDataMore:self.csvModel uid:self.uid cellNumber:self.cellNumber];
//        }
//        
//        
//    });
